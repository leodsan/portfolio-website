  ...
  return (
    <footer className="relative pt-52 pb-8 overflow-hidden">
      ...
      <div className="app-container flex flex-col items-center justify-center">
        <div className="flex items-center justify-center w-[460px] aspect-square max-w-[65vw] relative before:-z-10 before:rotate-45 before:w-full before:h-full before:bg-green-650 before:absolute before:content-['']">
